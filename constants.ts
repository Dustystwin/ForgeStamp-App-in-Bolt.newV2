...
// PRICING PLANS
// ---------------------------------------------------------------------------
// NOTE: The prices below are PLACEHOLDERS — change the `price` values to your
// real prices before launch. Billing is not connected yet, so the Creator and
// Pro buttons show a "coming soon" message (controlled by `available: false`).
// Set `available: true` once checkout exists for that plan.
