...
export function EditorPage({ onNavigateHome }: EditorPageProps) {
  ...
  // Full Reset: return the EDITOR to a completely fresh session — clears the
  // uploaded image and all settings (via reset) plus any lingering toast.
  // Deliberately does NOT clear the finished-images gallery: those are the
  // user's exported keepers and must survive a reset.
